        ...
        <div className="flex gap-3 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-64">
             ...
             <input 
                ...
                className="w-full pl-9 pr-4 py-2 bg-secondary border border-border rounded-lg text-sm text-foreground focus:ring-1 focus:ring-primary outline-none placeholder:text-muted-foreground"
             />
          </div>
          <Button 
            variant="outline" 
                 ...
                 <div className={`p-3 border-b flex flex-col gap-1 rounded-t-xl ${
                  ...
                  <div className="flex justify-between items-center">
                   ...
                   <div className="text-[10px] text-muted-foreground font-medium">
                      Total: <span className={isWonColumn ? 'text-emerald-600' : isLostColumn ? 'text-red-600' : 'text-foreground'}>{formatCurrency(totalValue)}</span>
                  </div>
                </div>
                  ...
                  {columnDeals.map((deal) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 mb-2 flex-wrap">
                         {deal.tags.map(tag => (
                             <span key={tag} className="text-[9px] text-muted-foreground bg-secondary px-1.5 py-0.5 rounded flex items-center gap-1">
                             ...
                             <div className="flex items-center gap-2 text-muted-foreground text-sm flex-wrap">
                                ...
                                <span className="flex items-center gap-1"><Building className="w-3 h-3" /> {selectedDeal.company}</span>
                                 ...
                                 <Select value={selectedDeal.ownerId || ''} onValueChange={handleOwnerChange}>
                                   <SelectTrigger className="w-[180px] h-7 text-xs bg-secondary border-border">
                    ...
                    <div className="p-6 border-b border-border bg-card/50">
                        <div className="flex gap-4 mb-4">
                            ...
                            <button 
                             ...
                             >
                                 <div className={`p-2 rounded-full ${activeTab === 'activity' ? 'bg-amber-500/10' : 'bg-secondary'}`}>
                            ...
                            <button 
                             ...
                             >
                                 <div className={`p-2 rounded-full ${activeTab === 'email' ? 'bg-violet-500/10' : 'bg-secondary'}`}>
                         ...
                         <div className="bg-card border border-border rounded-xl overflow-hidden focus-within:ring-1 focus-within:ring-primary/50 transition-all shadow-inner">
                            ...
                            />
                             <div className="px-3 py-2 bg-secondary/50 border-t border-border flex justify-between items-center">
                                 <div className="flex gap-2">
                                     <button className="p-1.5 hover:bg-secondary rounded text-muted-foreground hover:text-primary transition-colors"><Paperclip className="w-4 h-4" /></button>
                                </div>
                        ...
                        {loadingActivities ? (
                          ...
                          <div className="space-y-3">
                            {activities.map(activity => {
                              ...
                              return (
                                <div key={activity.id} className="flex items-start gap-3 p-3 rounded-xl bg-card border border-border hover:border-primary/20 transition-all group">
                                  <button 
                               ...
                               className={`p-2 rounded-lg text-sm ${
                                   msg.from_type === 'user' 
                                     ...
                                     : msg.from_type === 'nina'
                                       ...
                                       : 'bg-emerald-50 text-foreground ml-8 mr-0'
                                }`}
                              >
