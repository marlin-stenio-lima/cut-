        ...
        className={`
          ...
          ${isCompleted 
            ...
            : isActive 
              ...
              : isOptional
                ? 'border-border text-muted-foreground bg-secondary border-dashed'
                : 'border-border text-muted-foreground bg-secondary'
          }
        `}
        animate={isActive ? {
          boxShadow: [
            '0 0 0px hsla(0, 78%, 50%, 0.4)',
            '0 0 25px hsla(0, 78%, 50%, 0.6)',
            '0 0 0px hsla(0, 78%, 50%, 0.4)',
          ],
        } : {}}
        transition={{
              ...
              <div className="flex items-center justify-between p-6 pt-7 border-b border-border">
                <div className="flex items-center gap-3">
                  <motion.div
                    ...
                    animate={{ 
                      boxShadow: [
                        '0 0 0px hsla(0, 78%, 50%, 0.3)',
                        '0 0 15px hsla(0, 78%, 50%, 0.4)',
                        '0 0 0px hsla(0, 78%, 50%, 0.3)',
                      ]
                    }}
