      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mb-8 bg-card p-2 rounded-xl border border-border">
        <div className="relative flex-1 w-full">
          ...
          <input 
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-lg bg-secondary border border-border text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 placeholder:text-muted-foreground transition-all"
          />
        </div>
        <Button 
          variant="outline" 
          className="w-full sm:w-auto bg-secondary border-border text-muted-foreground cursor-not-allowed opacity-50"
          disabled
                  ...
                  <tr key={contact.id} className="hover:bg-secondary/50 transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-primary/10 border border-border flex items-center justify-center text-sm font-bold text-primary shadow-inner">
