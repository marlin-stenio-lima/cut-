  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="text-center mb-8">
        ...
        <h3 className="text-xl font-semibold text-foreground mb-2">Configurar Executer AI First</h3>
        <p className="text-muted-foreground text-sm max-w-md mx-auto">
          Defina a personalidade e comportamento do seu Executer AI First.
        </p>
      </motion.div>
      ...
      <div className="space-y-6 max-w-lg mx-auto">
        ...
        <motion.div variants={itemVariants} className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="Descreva como o Executer AI First deve se comportar, qual seu tom de voz, objetivos, e informações importantes sobre a empresa..."
        ...
        >
          ...
          <ul className="text-xs text-muted-foreground space-y-1">
            <li>• Defina claramente o objetivo do Executer AI First (vendas, suporte, etc)</li>
            <li>• Especifique o tom de voz (formal, casual, amigável)</li>
            <li>• Inclua informações sobre produtos/serviços</li>
            <li>• Defina limites do que o Executer AI First pode ou não fazer</li>
          </ul>
        </motion.div>
      </div>
    </motion.div>
