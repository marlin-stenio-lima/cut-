    ...
    >
      <motion.div variants={itemVariants} className="text-center mb-8">
        ...
        <p className="text-slate-400 text-sm max-w-md mx-auto">
          Configure o ElevenLabs para que seu Executer AI First responda também por áudio.
        </p>
        ...
        <motion.div variants={itemVariants} className="flex items-center justify-between p-4 rounded-lg bg-slate-800/30 border border-slate-700/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">O Executer enviará mensagens de voz</p>
            </div>
          </div>
          <Switch
